...
class Shinka_Moon_Entity_Moon
{
    ...
    public function toArray()
    {
        ...
        $full_moon = $this->full_moon();
        $full_moon = $full_moon < time() ? $this->next_full_moon() : $full_moon;

        $new_moon = $this->new_moon();
        $new_moon = $new_moon < time() ? $this->next_new_moon() : $new_moon;

        $stage = $this->phase() < 0.5 ? 'waxing' : 'waning';
        $phase = $this->phase_name();
